...
create table public.group_prediction_settings (
  ...
  table_exact_position_points int not null default 1,
  table_advancing_status_points int not null default 0,
  table_group_winner_bonus int not null default 0,
  ...
  knockout_round_of_32_points int not null default 1,
  knockout_round_of_16_points int not null default 2,
  knockout_quarter_final_points int not null default 4,
  knockout_semi_final_points int not null default 8,
  knockout_champion_points int not null default 16,
  knockout_third_place_points int not null default 4,
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now()
);
